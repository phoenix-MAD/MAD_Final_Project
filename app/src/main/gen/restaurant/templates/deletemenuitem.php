  ...
  <body>
  	...
  	<div class="container">
        ...
        <div class="row add-margin">
          <div class="col-md-12">
            <h3 style="color:white"> Delete Menu Item </h3>
          </div>
        </div>
        ...
        <div class="row pad-left">
          ...
          <?php if(isset($menu_item)){ ?>
            <div class="delete-user">
               ...
               <h4 class="color-white"><strong style="color:white;"> <?php echo 'Are you sure you want to delete <span style="color:yellow;">' . $menu_item->item_name . '</span> from database?'; ?> </strong> </h4>

            <form method="POST" action="">
              <input type="hidden" name="id" value="<?php if(isset($menu_item)) echo $menu_item->menu_item_id; ?>">
